 ...
 */
public class Action_JoinGameCOOP extends AbstractAction implements GameModeInterface {
    /**
     ...
     */
    public Action_JoinGameCOOP(Game game, String ip, String port) {
        super("Join Game [COOP]");
        this.game = game;
        this.port = port;
        this.hostIP = ip;
    }
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        this.game.initializeGameData(true, false, GameMode.COOP); // Resets the game's objects to their default state.
