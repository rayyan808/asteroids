 ...
 */
public class Action_HostGameDeathMatch extends AbstractAction implements GameModeInterface {
    /**
     ...
     */
    public Action_HostGameDeathMatch(Game game) {
        super("Host Game [DEATHMATCH]");
        this.game = game;
    }
    ...
    public void actionPerformed(ActionEvent actionEvent) {
            ...
            this.game.initializeGameData(true, true, GameMode.Deathmatch); // Resets the game's objects to their default state.
